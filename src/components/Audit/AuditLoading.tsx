    ...
    <div className="space-y-6">
      {isFetching && (
        <div className="flex items-center gap-3">
          <div className="border-border-secondary border-t-text-secondary h-4 w-4 animate-spin rounded-full border-2" />
          <span className="text-ink-secondary text-sm">Fetching site content...</span>
        </div>
      )}
      ...
      {Object.keys(responses).length === 2 && (
        <div className="flex items-center gap-3">
          <div className="border-border-secondary border-t-text-secondary h-4 w-4 animate-spin rounded-full border-2" />
          <span className="text-ink-secondary text-sm">Analyzing gaps across models...</span>
        </div>
      )}
    </div>
  );
